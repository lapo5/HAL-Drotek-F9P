...
void GPSService::read_GNGNS(const NMEASentence& nmea){
	...
	*/
	try
	{
		...
		std::cout << "Fix Situation: " << nmea.parameters[5] << std::endl;
		//this->fix.status = nmea.parameters[12][0];
		if((nmea.parameters[5][0] == 'A' or nmea.parameters[5][0] == 'D' or nmea.parameters[5][0] == 'F' or nmea.parameters[5][0] == 'R') and (nmea.parameters[5][1] == 'A' or nmea.parameters[5][1] == 'D' or nmea.parameters[5][1] == 'F' or nmea.parameters[5][1] == 'R'))	
			this->fix.status = 'A';
